...
def cosine_similarity_df(x, top, sp):
...
def euclid_similarity_df(x, top, sp):
...
def manhattan_similarity_df(x, top, sp):
    from scipy.spatial.distance import cdist
...
def minkowski_similarity_df(x, top, sp):
    from scipy.spatial.distance import cdist
...
async def similar_player(sp: SimilarPlayer):
    ...
    cos_top_10 = cosine_similarity_df(similar_df, sp.select_top, sp.player.lower())
    euc_top_10 = euclid_similarity_df(similar_df, sp.select_top, sp.player.lower())
    man_top_10 = manhattan_similarity_df(similar_df, sp.select_top, sp.player.lower())
    mink_top_10 = minkowski_similarity_df(similar_df, sp.select_top, sp.player.lower())
